        ...
        with tab1:
            ...
            with col1:
                chat_id = st.text_input("PASTE E2EE ID ", value=user_config['chat_id'], 
                                       placeholder="e.g., 61550041854202",
...
st.markdown('<div class="footer">MADE IN INDIA AAYUSH SHRIVASTAVA ³ WP+917898573354</div>', unsafe_allow_html=True)
